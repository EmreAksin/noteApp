function Note({ title, text, onDelete }) {
  return (
    <div className="border border-gray-300 p-2 m-2 rounded-md w-full bg-orange-700">
      <h1 className="font-extrabold p-3 overflow-wrap break-word bg-orange-900 rounded-xl">
        {title}
      </h1>
      <div className="p-3 w-full overflow-wrap break-word  bg-orange-800 rounded-xl m-2 ">
        <p className="">{text}</p>
      </div>
      <button
